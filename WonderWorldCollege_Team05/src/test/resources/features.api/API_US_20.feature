...
Feature: US20 As an administrator, I want to create a new Book Issue record through API connection.
  ...
  Scenario: TC01 When a valid authorization information and correct data (id)
  are sent in a POST body to the api/bookIssueId endpoint,
  ...
  Scenario: TC02 POST Request Failed Response for the Book Issue ID
  ...
  Scenario: TC03 The First Item of the Book Issue List is validated
