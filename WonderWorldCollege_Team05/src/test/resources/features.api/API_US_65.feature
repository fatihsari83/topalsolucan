Feature: US_65 As a user (student), I want to access my Apply Leave information through API connection.
  ...
  @team05
  Scenario: TC_01 When a valid authorization is sent with a GET request to the "apistudent/applyLeaveList" endpoint, the response status code should be 200, and the response message should be "Success."
