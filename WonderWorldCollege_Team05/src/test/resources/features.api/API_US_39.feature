Feature: US39 As an administrator, I want to access the Notice information of a user with a given ID through API connection.
  ...
  Scenario: TC01 When a valid authorization and correct data (id) are sent with a POST body to the api/getNoticeById endpoint,
  ...
  Scenario: TC02 When invalid authorization or invalid data (id) is sent with a POST body to the api/getNoticeById endpoint,
